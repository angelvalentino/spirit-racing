    ...
    <li className="product-preview">
      <Link to={`/jackets/${product.id}`}> 
        <div className="product-preview__image-wrapper">
          <img className="product-preview__image" src={product.images[0].url + '-m.jpg'} alt={product.title} />
          <img aria-hidden="true" role="presentation" className="product-preview__image-secondary" src={product.images[1].url + '-m.jpg'} alt='' />
        </div>
